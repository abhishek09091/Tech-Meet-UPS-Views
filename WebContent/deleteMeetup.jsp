  ...
  <div id="main">
    <div id="header">
      ...
      <div id="menubar">
        <ul id="menu">
          ...
          <li class="current"><a href="deleteMeetup.jsp">Delete Meetup</a></li>
    ...
    <div id="site_content">
      ...
      <div id="content">
        ...
        <form onsubmit="return deleteMeetup()">
        <input type="number" placeholder="Meetup Id to delete" id="id" name="id	">	
